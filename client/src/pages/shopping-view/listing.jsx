        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
          {productList && productList.length > 0
            ? productList.map((productItem) => (
                <ShoppingProductTile
                  key={productItem._id} // Ensure a key is passed for each product
                  handleGetProductDetails={handleGetProductDetails}
                  product={productItem}
                  handleAddtoCart={handleAddtoCart}
                  currency={currency} // Pass currency prop to ShoppingProductTile
                  exchangeRates={exchangeRates} // Pass exchangeRates prop to ShoppingProductTile
                  convertedPrice={convertPrice(productItem.price)} // Pass converted price to the product tile
                  convertedSalePrice={
                    productItem.salePrice > 0
                      ? convertPrice(productItem.salePrice)
                      : null
                  } // Pass converted sale price
                />
              ))
            : null}
        </div>
